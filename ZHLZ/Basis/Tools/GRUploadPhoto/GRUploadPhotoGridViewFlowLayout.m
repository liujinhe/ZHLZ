//
//  GRUploadPhotoGridViewFlowLayout.m
//  GR
//
...
@interface GRUploadPhotoGridViewFlowLayout () <UIGestureRecognizerDelegate>

@property (nonatomic, readonly) id<GRUploadPhotoGridViewDataSource> dataSource;
@property (nonatomic, readonly) id<GRUploadPhotoGridViewDelegateFlowLayout> delegate;

@end

@implementation GRUploadPhotoGridViewFlowLayout
{
...
- (id<GRUploadPhotoGridViewDataSource>)dataSource {
    return (id<GRUploadPhotoGridViewDataSource>)self.collectionView.dataSource;
}

- (id<GRUploadPhotoGridViewDelegateFlowLayout>)delegate {
    return (id<GRUploadPhotoGridViewDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress {
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            GRUploadPhotoCell *sourceCell = (GRUploadPhotoCell *)sourceCollectionViewCell;
