...
@interface ZHLZBrigadePickerViewVC () <UIPickerViewDataSource, UIPickerViewDelegate>
{
...
@implementation ZHLZBrigadePickerViewVC
...
- (void)loadData {
    @weakify(self);
    self.task = [[ZHLZOtherVM sharedInstance] getBrigadeWithBlock:^(NSArray<ZHLZBrigadeModel *> * _Nonnull array) {
        @strongify(self);
        self.array = array;
...
- (IBAction)determineAction {
    ...
    [self dismissViewControllerAnimated:NO completion:^{
        @strongify(self);
        ZHLZBrigadeModel *model = self.array[self->_currentIndex];
